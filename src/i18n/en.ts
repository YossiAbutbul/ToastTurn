...
export const en = {
  ...
  settings: {
    ...
    rotationBlurb: 'The order along the bottom of the screen. Drag a handle to change who comes after who.',
    dragPerson: (name: string) => `Move ${name}. Drag the handle, or use the up and down arrow keys`,
    upFirst: 'Up now',
